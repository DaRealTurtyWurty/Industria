...
public class DigesterModel extends Model {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        modelPartData.addChild("main", ModelPartBuilder.create().uv(0, 0).cuboid(-28.0F, -80.0F, -12.0F, 40.0F, 80.0F, 40.0F, new Dilation(0.0F)), ModelTransform.pivot(8.0F, 24.0F, -8.0F));
