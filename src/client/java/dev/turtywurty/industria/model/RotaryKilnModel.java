...
public class RotaryKilnModel extends Model {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        modelPartData.addChild("seg0", ModelPartBuilder.create().uv(0, 0).cuboid(-40.0F, -64.0F, -8.0F, 80.0F, 80.0F, 16.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 8.0F, 0.0F));
