...
public class ClarifierModel extends Model {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData main = modelPartData.addChild("main", ModelPartBuilder.create().uv(0, 135).cuboid(-8.0F, -2.0F, -23.0F, 16.0F, 1.0F, 31.0F, new Dilation(0.0F))
                ...
                .uv(218, 77).cuboid(10.0F, -22.0F, -13.0F, 4.0F, 1.0F, 26.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 24.0F, 0.0F));
        ...
        ModelPartData bone6 = main.addChild("bone6", ModelPartBuilder.create(), ModelTransform.pivot(1.0F, -12.0F, 11.0F));
        ...
        ModelPartData bone = main.addChild("bone", ModelPartBuilder.create().uv(142, 175).cuboid(-24.0F, -32.0F, -23.0F, 48.0F, 4.0F, 4.0F, new Dilation(0.0F))
                ...
                .uv(142, 184).cuboid(-24.0F, -32.0F, 19.0F, 48.0F, 4.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData bone2 = main.addChild("bone2", ModelPartBuilder.create(), ModelTransform.pivot(20.0553F, -31.9453F, -0.5F));
        ...
        ModelPartData bone3 = main.addChild("bone3", ModelPartBuilder.create(), ModelTransform.pivot(-20.0513F, -31.9416F, -0.5F));
        ...
        ModelPartData bone4 = main.addChild("bone4", ModelPartBuilder.create(), ModelTransform.pivot(0.5F, -27.0247F, -1.002F));
        ...
        ModelPartData bone5 = main.addChild("bone5", ModelPartBuilder.create(), ModelTransform.pivot(0.5F, -27.0284F, 1.002F));
