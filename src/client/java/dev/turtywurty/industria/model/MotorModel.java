...
public class MotorModel extends Model {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData spinRod = main.addChild("spinRod", ModelPartBuilder.create().uv(0, 33).cuboid(-1.5F, -0.5F, -0.5F, 3.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(5.5F, -15.0F, 28.0F));
