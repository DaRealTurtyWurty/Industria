...
public class DrillMotorModel extends Model {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData spinRod = main.addChild("spinRod", ModelPartBuilder.create(), ModelTransform.pivot(-18.7417F, 42.6045F, -13.0001F));
        ...
        ModelPartData rodGear = spinRod.addChild("rodGear", ModelPartBuilder.create().uv(15, 33).cuboid(-7.75F, -0.5F, -0.5F, 10.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(34, 18).cuboid(2.25F, -2.5F, -2.5F, 1.0F, 5.0F, 5.0F, new Dilation(0.0F)), ModelTransform.pivot(29.5333F, -46.65F, 13.0F));

        ModelPartData connectingGear = spinRod.addChild("connectingGear", ModelPartBuilder.create().uv(15, 36).cuboid(-0.5F, -2.5F, -2.5F, 1.0F, 5.0F, 5.0F, new Dilation(0.0F)), ModelTransform.pivot(32.2833F, -46.65F, 18.0F));
