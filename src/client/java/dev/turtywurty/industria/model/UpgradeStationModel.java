...
public class UpgradeStationModel extends Model<UpgradeStationRenderState> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData main = modelPartData.addChild("main", ModelPartBuilder.create().uv(0, 0).cuboid(-24.0F, -16.0F, -40.0F, 48.0F, 16.0F, 64.0F, new Dilation(0.0F))
                .uv(0, 80).cuboid(-8.0F, -32.0F, -24.0F, 16.0F, 16.0F, 16.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 24.0F, 0.0F));
