...
public class WindTurbineModel extends Model {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData core = modelPartData.addChild("core", ModelPartBuilder.create().uv(0, 0).cuboid(-1.0F, -28.125F, -10.0625F, 2.0F, 2.0F, 3.0F, new Dilation(0.0F))
                ...
                .uv(0, 6).cuboid(-2.0F, -29.125F, -7.0625F, 4.0F, 4.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -7.875F, 0.0625F));

        ModelPartData propellers = modelPartData.addChild("propellers", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, -35.0F, -8.0F));

        ModelPartData propeller0 = propellers.addChild("propeller0", ModelPartBuilder.create().uv(50, 48).cuboid(-1.0F, -21.0F, -1.0F, 2.0F, 22.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
