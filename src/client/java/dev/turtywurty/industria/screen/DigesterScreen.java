...
public class DigesterScreen extends HandledScreen<DigesterScreenHandler> {
    private static final Identifier TEXTURE = Industria.id("textures/gui/container/digester.png");

    public DigesterScreen(DigesterScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void init() {
        ...
        addDrawable(new SlurryWidget.Builder(this.handler.getBlockEntity().getInputSlurryStorage())
