...
public class ItemInit {
    ...
    public static Item registerWithSettings(String name, Function<Item.Properties, Item.Properties> settingsApplier) {
        return registerItem(name, new Item(settingsApplier.apply(new Item.Properties()
                .setId(ResourceKey.create(Registries.ITEM, Industria.id(name))))));
    }

    public static <T extends Item> T register(String name, Function<Item.Properties, T> constructor, Function<Item.Properties, Item.Properties> settingsApplier) {
    ...
    public static <T extends Item> T register(String name, Function<Item.Properties, T> constructor) {
