...
public class ScreenHandlerTypeInit {
    ...
    public static final ScreenHandlerType<ArcFurnaceScreenHandler> ARC_FURNACE =
            register("arc_furnace", ArcFurnaceScreenHandler::new, BlockPosPayload.CODEC);

    public static final ExtendedScreenHandlerType<MultiblockDesignerScreenHandler, BlockPosPayload> MULTIBLOCK_DESIGNER =
