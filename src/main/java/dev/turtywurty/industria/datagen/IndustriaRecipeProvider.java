        ...
        return new RecipeGenerator(wrapperLookup, exporter) {
            ...
            public void generate() {
                ...
                offerAlloySmelting(exporter, RecipeCategory.MISC,
                        CountedIngredient.fromTag(1, itemLookup.getOrThrow(ConventionalItemTags.IRON_INGOTS)),
                        CountedIngredient.fromTag(4, itemLookup.getOrThrow(ItemTags.COALS)),
                ...
                offerCrusher(exporter, RecipeCategory.MISC,
                        CountedIngredient.fromTag(1, itemLookup.getOrThrow(ConventionalItemTags.QUARTZ_ORES)),
...
//        offerCrusher(exporter, RecipeCategory.MISC,
//                CountedIngredient.fromTag(1, itemLookup.getOrThrow(ConventionalItemTags.IRON_RAW_MATERIALS)),
...
//        offerCrusher(exporter, RecipeCategory.MISC,
//                CountedIngredient.fromTag(1, itemLookup.getOrThrow(ConventionalItemTags.GOLD_ORES)),
...
//        offerCrusher(exporter, RecipeCategory.MISC,
//                CountedIngredient.fromTag(1, itemLookup.getOrThrow(ConventionalItemTags.COPPER_RAW_MATERIALS)),
...
//                200);
    ...
    private static void offerCrusher(RecipeExporter exporter, RecipeCategory category, List<ItemStack> input, OutputItemStack outputA, OutputItemStack outputB, int processTime, String name) {
