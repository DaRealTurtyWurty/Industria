...
public class DistillationTowerBlockEntityRenderer extends IndustriaBlockEntityRenderer<DistillationTowerBlockEntity, DistillationTowerRenderState> {
    ...
    private void renderFluidColumn(@Nullable net.fabricmc.fabric.api.transfer.v1.fluid.base.SingleFluidStorage storage,
        ...
        float fluidProgress = (float) storage.amount / (FluidConstants.BUCKET * 5);
