...
public class EntityModelLayerInit {
    ...
    public static void init() {
        ...
        ModelLayerRegistry.registerModelLayer(MixerModel.LAYER_LOCATION, MixerModel::getMainLayer);
        ...
        ModelLayerRegistry.registerModelLayer(DistillationTowerModel.LAYER_LOCATION, DistillationTowerModel::createMainLayer);
