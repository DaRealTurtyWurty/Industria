...
import dev.turtywurty.industria.menu.MotorScreenHandler;
...
public class MotorBlockEntity extends IndustriaBlockEntity implements SyncableTickableBlockEntity, BlockEntityWithGui<BlockPosPayload> {
    ...
    public MotorBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlocks.MOTOR.get(), ModBlockEntityTypes.MOTOR.get(), pos, state);
    ...
    public ResourceStorage<ResourceVariant<UnitResource>> getEnergyProvider(Direction ignored) {
